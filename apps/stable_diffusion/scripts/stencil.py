...
def img2img_inf(
    ...
    if not stencil2img_obj or config_obj != new_config_obj:
        ...
        stencil2img_obj = StencilPipeline.from_pretrained(
            scheduler_obj,
            args.import_mlir,
            args.hf_model_id,
            args.ckpt_loc,
    ...
    stencil2img_obj.scheduler = schedulers[scheduler]
    ...
    for current_batch in range(batch_count):
        ...
        out_imgs = stencil2img_obj.generate_images(
            prompt,
            negative_prompt,
            image,
            batch_size,
    ...
    text_output += stencil2img_obj.log
...
if __name__ == "__main__":
    ...
    start_time = time.time()
    generated_imgs = stencil2img_obj.generate_images(
        args.prompts,
