...
class Image2ImagePipeline(StableDiffusionPipeline):
    ...
    def prepare_image_latents(
        ...
        # TODO: process with variable HxW combos (when available)

        # Pre process image
        image = image.resize((height, width)) # Currently only 512x512 supported
        ...
        # image encode
        latents = self.encode_image("forward", (image_arr,))
